...
function Setting_Group_CreateOrJoin(){
                ...
                (
                    <div style={{width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start'}}>
                        <ScrollContainer style={{overflowY: 'scroll', flex: 1}}>
                            <Modal style={{marginBottom: 20, backgroundColor: 'rgba(255, 255, 255, 0.6)', border: '1px solid rgba(42, 50, 71, 0.3)'}}>
...
export default Setting_Group_CreateOrJoin;